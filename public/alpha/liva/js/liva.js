(() => {
  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/constants.js
  var LivaPositions = {
  ...
  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/error-tracker.js
  ...
  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/dom.js
  var livaContainer = document.querySelector(
    '[data-alpha="liva-container"]'
  );
  var livaConsoleContainer = document.querySelector(
    '[data-alpha="liva-console-container"]'
  );
  var livaConsoleContent = document.querySelector(
    '[data-alpha="liva-console-content"]'
  );
  var livaFab = document.querySelector('[data-alpha="liva-fab-button"]');
  var livaSettings = document.querySelector(
    '[data-alpha="liva-settings"]'
  );
  var livaSettingsCloseBtn = document.querySelector(
    '[data-alpha="liva-close-settings"]'
  );
  var selectPositionElement = document.querySelector(
    '[data-alpha="liva-select-position"]'
  );
  var livaOpenConsoleBtn = document.querySelector(
    '[data-alpha="liva-open-console-button"]'
  );
  var livaUpdateBtn = document.querySelector(
    '[data-alpha="liva-updates-button"]'
  );
  var livaConsole = document.querySelector('[data-alpha="liva-console"]');
  var livaConsoleCloseBtn = document.querySelector(
    '[data-alpha="liva-close-console"]'
  );
  var livaConsoleHelpBtn = document.querySelector(
    '[data-alpha="liva-console-help-button"]'
  );
  var livaConsoleResetBtn = document.querySelector(
    '[data-alpha="liva-console-reset-button"]'
  );
  var localAlphaVersionEl = document.querySelector(
    '[data-alpha="local-alpha-version"]'
  );
  var localHugoVersionEl = document.querySelector(
    '[data-alpha="local-hugo-version"]'
  );
  var alphaBadge = document.querySelector(
    '[data-alpha="liva-alpha-update-badge"]'
  );
  var hugoBadge = document.querySelector(
    '[data-alpha="liva-hugo-update-badge"]'
  );

  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/fab-controller.js
  ...
  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/update-checker.js
  ...
  // ns-hugo-imp:/Users/thomaskonig/Documents/GitHub/blog/themes/alpha/assets/alpha/liva/js/modules/ui-controller.js
